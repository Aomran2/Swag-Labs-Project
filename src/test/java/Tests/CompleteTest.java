...
//        driver = new EdgeDriver();
    ...
    public void completion() throws IOException {
        ...
        new HomePage(getDriver())
                ...
                .clickOnCheckout()
                .fillCheckoutData()
                .clickContinue().finishOrder();

        soft.assertTrue(new CompletePage(getDriver()).checkVisibilityOfCompleteMessage());
        soft.assertEquals(getPropertyData("Environment", "complete"), getDriver().getCurrentUrl());
        soft.assertAll();
